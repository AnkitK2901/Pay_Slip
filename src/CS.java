...
class TEMPORARYEmployee extends Employee {
    ...
    public TEMPORARYEmployee(int id, String name, double salary, int workDays, double deduction, double bonus, double dailyWage) {
        super(name, salary, deduction, bonus);
        this.id = id;
...
//    	int id, String name, double salary, int workDays, double deduction, double bonus, double dailyWage, String type
//    	new SalarySlip(id, name, workDays, dailyWage, deduction, bonus, "T", (workDays * dailyWage));
...
public class CS {
    ...
    public void addPERMANENTEmployee(int id, String name, double salary, double deductions, double bonuses) throws ClassNotFoundException, FileNotFoundException {
        PERMANENTEmployee temp = new PERMANENTEmployee(id, name, salary, deductions, bonuses);
        temp.loadDataPERMANENT();
    }
    
    public void addTEMPORARYEmployee(int id, String name, double salary, int workingDays, double dailyWage, double deductions, double bonuses) throws ClassNotFoundException, FileNotFoundException {
...
//        String writeThis = "\n\n_____|/|/|/|:PAY SLIP:|/|/|/|_____\n"+"Pay Slip for TEMPORARY Employee:\n\n"+"\nName: " + data[1]+"\nID: " + data[0]+"\nSalary: " + data[7]+"\nWorking Days: " + data[2]+"\nDaily Wage: " + data[3]+"\nDeduction: "+ data[4]+"\nBonus: " + data[5]+"\nEmployee Type: " + data[6]+"\nNet Salary: " + (salary - deduction + bonus) + "\n";
//        JOptionPane.showMessageDialog(null, writeThis);
    }
