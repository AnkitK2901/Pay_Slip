...
public class App{
    ...
    static void addRecord(int id, String name, int workingDays, double dailyWage, double deductions, double bonuses, String type, double salary) throws ClassNotFoundException{
        Class.forName("com.mysql.cj.jdbc.Driver");
        try(Connection con = DBConnection.getConnection();Statement s = con.createStatement()){
            name = "'" + name.toUpperCase() + "'";
            type = "'" + type.toUpperCase() + "'";
            String sql = "INSERT INTO PAYSLIP VALUES(" + id + ',' + name + ',' + workingDays + ',' + dailyWage + ',' + deductions + ',' + bonuses + ',' + type + "," + salary + ")";
            s.executeUpdate(sql);
    ...
    public static String[] generatePaySlipTEMPORARY(int id) throws ClassNotFoundException{ return generatePaySlip(id, "'T'"); }
    public static String[] generatePaySlipPERMANENT(int id) throws ClassNotFoundException{ return generatePaySlip(id, "'P'"); }
